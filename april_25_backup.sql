...
INSERT INTO `CountryImmunizationRecords` VALUES ('AD','Andorra',90296),('AF','Afghanistan',90281),('AG','Antigua and Barbuda',90378),('AI','Anguilla',90375),('AL','Albania',90283),('AM','Armenia',90389),('AO','Angola',90371),('AQ','Antarctica',90376),('AR','Argentina',90379),('AS','American Samoa',90291),('AT','Austria',90470),('AU','Australia',90396),('AW','Aruba',90393),('AZ','Azerbaijan',90476),('BA','Bosnia and Herzegovina',90645),('BB','Barbados',90620),('BD','Bangladesh',90585),('BE','Belgium',90625),('BF','Burkina Faso',90653),('BG','Bulgaria',90651),('BH','Bahrain',90581),('BI','Burundi',90654),('BJ','Benin',90632),('BM','Bermuda',90633),('BN','Brunei Darussalam',90650),('BO','Bolivia (Plurinational State of)',90636),('BQ','Bonaire, Sint Eustatius and Saba',90644),('BR','Brazil',90648),('BS','Bahamas (the)',90477),('BT','Bhutan',90634),('BV','Bouvet Island',90647),('BW','Botswana',90646),('BY','Belarus',90621),('BZ','Belize',90630),('CA','Canada',90658),('CC','Cocos (Keeling) Islands (the)',90665),('CD','Congo (the Democratic Republic of the)',90669),('CG','Congo (the)',90670),('CI','Côte d\'Ivoire',90682),('CK','Cook Islands (the)',90672),('CL','Chile',90662),('CM','Cameroon',90657),('CN','China',90663),('CO','Colombia',90666),('CR','Costa Rica',90673),('CU','Cuba',90675),('CV','Cabo Verde',90655),('CW','Curaçao',90676),('CX','Christmas Island',90664),('CY','Cyprus',90680),('CZ','Czechia',90681),('DE','Germany',90712),('DJ','Djibouti',90686),('DM','Dominica',90687),('DO','Dominican Republic (the)',90688),('DZ','Algeria',90287),('EC','Ecuador',90690),('EE','Estonia',90694),('EG','Egypt',90690),('ER','Eritrea',90693),('ET','Ethiopia',90697),('FI','Finland',90702),('FJ','Fiji',90701),('FK','Falkland Islands (the) [Malvinas]',90698),('FO','Faroe Islands (the)',90700),('FR','France',90703),('GA','Gabon',90707),('GD','Grenada',90717),('GE','Georgia',90710),('GF','French Guiana',90704),('GG','Guernsey',90723),('GH','Ghana',90713),('GI','Gibraltar',90714),('GL','Greenland',90716),('GM','Gambia (the)',90708),('GN','Guinea',90724),('GP','Guadeloupe',90718),('GQ','Equatorial Guinea',90692),('GR','Greece',90715),('GT','Guatemala',90721),('GU','Guam',90720),('GW','Guinea-Bissau',90725),('GY','Guyana',90726),('HR','Croatia',90674),('HT','Haiti',90727),('IN','India',90649),('KH','Cambodia',90656),('KM','Comoros (the)',90668),('KY','Cayman Islands (the)',90659),('PF','French Polynesia',90705),('SV','El Salvador',90691),('SZ','Eswatini',90696),('TD','Chad',90661),('TF','French Southern Territories (the)',90706);
...
CREATE TABLE `VaccinationRecords` (
  ...
  KEY `UserID` (`UserID`),
  KEY `PublicHealthCentreID` (`PublicHealthCentreID`),
  KEY `CampID` (`CampID`),
  ...
  CONSTRAINT `VaccinationRecords_ibfk_3` FOREIGN KEY (`PublicHealthCentreID`) REFERENCES `PublicHealthCentre` (`id`),
...
-- Dump completed on 2020-04-25 19:40:06
